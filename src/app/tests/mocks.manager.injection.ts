...
export const USER_MOCK_STORAGE = new InjectionToken<UserMockStorage>(
  'UserMockStorage'
);
export const CATEGORY_MOCK_STORAGE = new InjectionToken<CategoryMockStorage>(
  'CategoryMockStorage'
);
export const PRODUCT_MOCK_STORAGE = new InjectionToken<ProductMockStorage>(
  'ProductMockStorage'
);
export const ORDER_MOCK_STORAGE = new InjectionToken<OrderMockStorage>(
  'OrderMockStorage'
);

export const mocksInjection = [
